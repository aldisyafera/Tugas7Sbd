				...
				<div class="row">
					...
					<hr class="divider" />
						<article class="entry">
							...
							<p style="margin-left: 3px;"><img src="img/klinik.png" alt="klinik" width="189px" style="float:left;"> Kami melayani pasien rawat inap menggunakan BPJS maupun asuransi swasta dengan proses yang mudah</p>
						</article>
					</div>
					<div class="super">
					<hr class="divider" />
						<article class="entry ">
							...
							<p style="text-align:justify;"><img src="klinik1.png" alt="klinik" width="189px" style="float:right;"> Kami melayani pasien rawat jalan menggunakan BPJS maupun asuransi swasta dengan proses yang mudah</p>
						</article>
					</div>	
				</div>
			</div>
